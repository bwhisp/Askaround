...
<head>
  ...
  <meta charset="utf-8">
  <title>Askaround.fr : Inscription </title>
...
<body  >
  ...
  <nav class="navbar navbar-default navbar-fixed-top" role="navigation">
   ...
   <div class="jumbotron">
    <h1>Askaround heading</h1>
    <p>Pour visualiser toutes les questions posées :</p>
    <p><a href="home.php" class="btn btn-primary btn-lg" role="button">Plus de question &raquo;</a></p>
  </div>
...
// préparation de la requete
        $sql = "SELECT id, username, titre, date_derniere_reponse FROM forum_sujets WHERE username = '{$_SESSION['username']}' ORDER BY date_derniere_reponse DESC";
...
// on compte le nombre de sujets du forum
        ...
        if ($nb_sujets == 0) {
          echo 'Vous n\'avez posé aucune question !' ;
        }
        else {
          ?>

          <h3>Mes questions : </h3><br>
...
// préparation de la requete
  $sql = "SELECT id, username, titre, date_derniere_reponse FROM forum_sujets WHERE id NOT IN (SELECT correspondance_sujet FROM forum_reponses)  ORDER BY date_derniere_reponse DESC;";
...
// on compte le nombre de sujets du forum
  ...
  if ($nb_sujets == 0) {
    echo 'Aucune question sans réponse';
  }
  else {
    ?>

    <h3>Questions sans réponse: </h3><br>
    <table class="table table-striped"><tr>
      <td>
        Auteur
      </td><td>
...
<div class="row">
  <div class="blog-footer">
    <p>Question and respond site built  by Aberrahmane Kammous and Anass Seddiki.</p>
    <p>
